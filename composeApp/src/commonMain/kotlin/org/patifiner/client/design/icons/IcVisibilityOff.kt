...
val IcVisibilityOff: ImageVector
    get() {
        if (_icVisibilityOff != null) return _icVisibilityOff!!

        _icVisibilityOff = Builder(
            name = "IcVisibilityOff", defaultWidth = 24.0.dp, defaultHeight =
...
private fun Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = IcVisibilityOff, contentDescription = "")
    }
}
