...
val IcVisibilityOn: ImageVector
    get() {
        if (_icVisibilityOn != null) return _icVisibilityOn!!

        _icVisibilityOn = Builder(
            name = "IcVisibilityOn", defaultWidth = 24.0.dp, defaultHeight =
...
private fun Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = IcVisibilityOn, contentDescription = "")
    }
}
