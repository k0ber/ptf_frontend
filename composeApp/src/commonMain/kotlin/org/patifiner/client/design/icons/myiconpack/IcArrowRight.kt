...
public val MyIconPack.IcArrowRight: ImageVector
    get() {
        if (_icArrowRight != null) {
            return _icArrowRight!!
        }
        _icArrowRight = Builder(name = "IcArrowRight", defaultWidth = 24.0.dp, defaultHeight =
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MyIconPack.IcArrowRight, contentDescription = "")
    }
}
