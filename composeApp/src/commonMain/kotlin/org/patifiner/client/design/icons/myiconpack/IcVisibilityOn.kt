...
public val MyIconPack.IcVisibilityOn: ImageVector
    get() {
        if (_icVisibilityOn != null) {
            return _icVisibilityOn!!
        }
        _icVisibilityOn = Builder(name = "IcVisibilityOn", defaultWidth = 24.0.dp, defaultHeight =
...
private var _icVisibilityOn: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MyIconPack.IcVisibilityOn, contentDescription = "")
    }
}
