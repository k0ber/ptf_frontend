...
val IcPassword: ImageVector
    get() {
        if (_icPassword != null) return _icPassword!!

        _icPassword = Builder(
            name = "IcPassword", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
var _icPassword: ImageVector? = null

@Preview
@Composable
private fun Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = IcPassword, contentDescription = "")
    }
}
